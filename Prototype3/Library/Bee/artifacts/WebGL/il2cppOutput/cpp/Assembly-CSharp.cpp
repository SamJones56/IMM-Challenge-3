...
IL2CPP_EXTERN_C String_t* _stringLiteralCBE71B0064003CFEE75100550235F8DBD2D3D649;
...
IL_0041:
	...
	{
		bool L_7 = __this->___isLowEnough;
		if (!L_7)
		{
			goto IL_0075;
		}
	...
	{
		Rigidbody_t268697F5A994213ED97393309870968BC1C7393C* L_9 = __this->___playerRb;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_10;
		L_10 = Vector3_get_up_m128AF3FDC820BF59D5DE86D973E7DE3F20C3AEBA_inline(NULL);
		float L_11 = __this->___floatForce;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayerController_OnCollisionEnter_m2FC01282FAEE546C4408E6B901DBB3EB5A5BF989 (PlayerController_t7E8D7042FA2D0DFEC54A1FCDF395161D88DAAE95* __this, Collision_tBCC6AEBD9A63E6DA2E50660DAC03CDCB1FF7A9B0* ___0_collision, const RuntimeMethod* method) 
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		...
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteralCBE71B0064003CFEE75100550235F8DBD2D3D649);
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteralDDB91D5B0BDD1824A4CC18C279F4CF0A96D4A900);
		s_Il2CppMethodInitialized = true;
	}
	{
...
IL_0025:
	...
	{
		il2cpp_codegen_runtime_class_init_inline(Debug_t8394C7EEAECA3689C2C9B9DE9C7166D73596276F_il2cpp_TypeInfo_var);
		Debug_Log_m87A9A3C761FF5C43ED8A53B16190A53D08F818BB(_stringLiteralCBE71B0064003CFEE75100550235F8DBD2D3D649, NULL);
		__this->___gameOver = (bool)1;
		Animator_t8A52E42AE54F76681838FE9E632683EF3952E883* L_7 = __this->___playerAnim;
...
{
	{
		...
		Vector3__ctor_m376936E6B999EF1ECBE57D990A386303E2283DE0_inline((&L_0), (25.0f), (1.0f), (0.0f), NULL);
